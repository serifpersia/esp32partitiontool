...
class PrefsPanel extends JPanel {
	...
	private JPanel getSettingsPanel() {
		...
		JPanel myBorderCheckBox0 = getCheckBoxPropertyPanel(enableDebugCheckBox, "Enable debug",
				"Dramatically increases the application verbosity. Be ready to have your console flooded with a lot of information :-)");
		JPanel myBorderCheckBox1 = getCheckBoxPropertyPanel(confirmOverwriteCheckBox, "Auto overwrite",
				"Automatically overwrite partitions.csv without asking for confirmation.");
		JPanel myBorderCheckBox2 = getCheckBoxPropertyPanel(confirmDataEmptyCheckBox, "Warn if empty SPIFFS",
				"Will ask for confirmation if a 'data' folder is missing from the sketch folder before creating spiffs.bin.");
	...
	public JCheckBox getDebug() {
		return enableDebugCheckBox;
	}

	public JCheckBox getConfirmDataEmptyCheckBox() {
		return confirmDataEmptyCheckBox;
	}

	public JCheckBox getOverwriteCheckBox() {
		return confirmOverwriteCheckBox;
	}
