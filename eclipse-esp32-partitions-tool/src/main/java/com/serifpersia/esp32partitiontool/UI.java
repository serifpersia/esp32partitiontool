...
public class UI extends JPanel {
	...
	private static final int NUM_CHECKBOXES = 10;
	private JCheckBox[] checkBoxes = new JCheckBox[NUM_CHECKBOXES];
	...
	public UI() {
		...
		btn_GeneCSV = new JButton("Generate CSV");
		panel_9.add(btn_GeneCSV);
	...
	public JCheckBox getCheckBox(int index) {
		if (index >= 0 && index < NUM_CHECKBOXES) {
