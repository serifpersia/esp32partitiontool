...
set "resources_folder=%script_dir%resources"
...
REM Copy resources directory into the bin folder and automatically respond "D" (directory)
echo D | xcopy /s /y "%resources_folder%" "%bin_folder%\resources"
